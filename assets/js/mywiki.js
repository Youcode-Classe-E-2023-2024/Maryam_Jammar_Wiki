    ...
    $.ajax({
        ...
        success: function (data) {
            if (data === "Wiki added successfully") {
                alert(data);
                window.location.href = 'index.php?page=mywikis';
...
function deleteWiki(wiki_id) {
    $.get(
        "index.php?page=mywikis&delete=true&id=" + wiki_id,
        (data) => {
            console.log(data);
...
function archiveWiki(wiki_id) {
    $.get(
        "index.php?page=mywikis&archive=true&id=" + wiki_id,
        (data) => {
            console.log(data);
            alert("Wiki est archivée avec succée !");
            window.location.href = 'index.php?page=mywikis';
        }
    )
}
